...
namespace VBot
{
    /// <summary>Main class for dump entities</summary>
    /// <remarks>See also "http://dumps.wikimedia.org/other/wikidata/" </remarks>
    ...
    /// <summary>Main class for entity</summary>
    /// <remarks>See also "https://www.mediawiki.org/wiki/Wikibase/DataModel/Primer"</remarks>
    public class Entity
    {
        ...
        /// <summary>Return true if property exist</summary>
        ...
        public bool PropertyExist(string Property)
        {
            if (this.claims != null)
            {
                ...
                {
                    if (claim.Key == Property) { return true; }
                }
            }
            return false;
        }

        /// <summary>Return true if property with value exist</summary>
            ...
            if (this.claims != null)
            {
                foreach (KeyValuePair<string, List<Claim>> tmpClaims in this.claims)
                {
                    if (tmpClaims.Key == Property)
                    {
                        ...
                        {
                            if (tmpClaim.mainsnak.datavalue.FormatValue == dv.FormatValue) { return true; }
                        }
                    }
                }
            }
        ...
        /// <param name="Property">property to check (ex P123)</param>
        /// <param name="dv">value to check</param>
        public string PropertyValueId(string Property, Datavalue dv)
        {
            List<Datavalue> tmpList = new List<Datavalue>();
            if (this.claims != null)
            {
                foreach (KeyValuePair<string, List<Claim>> tmpClaims in this.claims)
                {
                    if (tmpClaims.Key == Property)
                    {
                        ...
                        foreach (Claim tmpClaim in tmpListClaim)
                        {
                            if (tmpClaim.mainsnak.datavalue.FormatValue == dv.FormatValue) { return tmpClaim.id; }
                        }
                    }
                }
            }
        ...
        /// <summary>Return a list of the datavalue of the property</summary>
        /// <param name="Property">property to check (ex P123)</param>
        ...
        /// <summary>Return a string with the datavalue of the property</summary>
        /// <param name="Property">property to check (ex P123)</param>
        /// <returns>string with the list of datavalue separatede by pipe (|) </returns>
        public string PropertyValueString(string Property)
        {
            string tmp = "";
            if (this.claims != null)
            {
                foreach (KeyValuePair<string, List<Claim>> tmpClaims in this.claims)
                {
                    if (tmpClaims.Key == Property)
                    {
                        ...
                        foreach (Claim tmpClaim in tmpListClaim)
                        {
                            if (tmpClaim.mainsnak.snaktype=="novalue")
                            {
                                tmp += "" + "|";
                            }
                            else
                            {
                                tmp += tmpClaim.mainsnak.datavalue.FormatValue + "|";
                            }
                        }
                    }
                }
        ...
        /// <summary>Return a list of the id of the property</summary>
        /// <param name="Property">property to check (ex P123)</param>
        /// <returns>list of propert</returns>
        public List<string> PropertiesId(string Property)
        {
    ...
    public class Datavalue //Abstract class
    {
        ...
        /// <summary>Return a formatted value of datavalue</summary>
    ...
    public class DatavalueCoordinate : Datavalue
    {
        ...
        public override string Json
        {
            get
            {
                ...
                _Json += "{\"latitude\":" + value.latitude + ",\"longitude\":" + value.longitude + ", \"precision\":" + value.precision + ", \"globe\":\"" + value.globe + "\"},";
    ...
    /// <summary>Deserializazion of Datavalue</summary>
